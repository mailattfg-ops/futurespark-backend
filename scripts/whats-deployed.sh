...
check "word cloud allowlist"          "$K/session-evidence.js" "canonicalFor"
check "contractions stripped"         "$K/session-evidence.js" "stripContraction"
check "word forms folded"             "$K/session-evidence.js" "wordVariants"
